...
TEST(VectorCorrectness, default_ctor) {
...
TEST(VectorCorrectness, push_back) {
    size_t const N = 5000;
    {
...
TEST(VectorCorrectness, push_back_from_self) {
    size_t const N = 500;
    {
        Vector<element<size_t> > a;
        a.push_back(42);
...
TEST(VectorCorrectness, subscription) {
    size_t const N = 500;
    Vector<size_t> a;
...
TEST(VectorCorrectness, front_back) {
    size_t const N = 500;
    Vector<element<size_t> > a;
    for (size_t i = 0; i != N; ++i) a.push_back(2 * i + 1);
...
TEST(VectorCorrectness, capacity) {
    size_t const N = 500;
    {
        Vector<element<size_t> > a;
        a.reserve(N);
...
TEST(VectorCorrectness, superfluous_reserve) {
...
TEST(VectorCorrectness, superfluous_shrink_to_fit) {
    size_t const N = 500;
    {
        Vector<element<size_t> > a;
        a.reserve(N);
...
TEST(VectorCorrectness, copy_ctor) {
    size_t const N = 500;
    {
        Vector<element<size_t> > a;
...
TEST(VectorCorrectness, assignment_operator) {
    size_t const N = 500;
    {
        Vector<element<size_t> > a;
        for (size_t i = 0; i != N; ++i) a.push_back(2 * i + 1);
...
TEST(VectorCorrectness, self_assignment) {
    size_t const N = 500;
    {
        Vector<element<size_t> > a;
        for (size_t i = 0; i != N; ++i) a.push_back(2 * i + 1);
...
TEST(VectorCorrectness, pop_back) {
    size_t const N = 500;
    Vector<element<size_t> > a;
...
TEST(VectorCorrectness, insert_begin) {
    size_t const N = 500;
    Vector<element<size_t> > a;
...
TEST(VectorCorrectness, insert_end) {
    size_t const N = 500;
    {
        Vector<element<size_t> > a;
...
TEST(VectorCorrectness, erase_begin) {
    size_t const N = 500;
    {
        Vector<element<size_t> > a;
...
TEST(VectorCorrectness, erase_end) {
    size_t const N = 500;
    {
        Vector<element<size_t>> a;
...
TEST(VectorCorrectness, erase_range_begin) {
    size_t const N = 500, K = 100;
    {
        Vector<element<size_t>> a;
...
TEST(VectorCorrectness, erase_range_middle) {
    size_t const N = 500, K = 100;
    {
        Vector<element<size_t>> a;
...
TEST(VectorCorrectness, erase_range_end) {
    size_t const N = 500, K = 100;
    {
        Vector<element<size_t>> a;
...
TEST(VectorCorrectness, erase_range_all) {
    size_t const N = 500;
    {
        Vector<element<size_t>> a;
...
TEST(VectorCorrectness, erase_big_range) {
    {
...
TEST(VectorCorrectness, reallocation_throw) {
    {
        Vector<element<size_t> > a;
        a.reserve(10);
        size_t n = a.capacity();
...
TEST(VectorCorrectness, empty_storage) {
    Vector<int> a;
...
TEST(VectorCorrectness, empty_storage_shrink_to_fit) {
    Vector<int> a;
    a.push_back(42);
    a.pop_back();
...
TEST(VectorCorrectness, copy_throw) {
    Vector<element<size_t> > a;
    a.reserve(10);
    size_t n = a.capacity();
    for (size_t i = 0; i != n; ++i) a.push_back(i);
...
TEST(VectorCorrectness, iter_types) {
...
TEST(VectorCorrectness, ctor_alloc) {
    Vector<element<size_t> > a;
    a.reserve(10);
    a.push_back(5);
